 ...
 * 
 * @author Adam/w15009283 
 * @version 1st version 10/12/2015
 */
...
{    
    ...
    /**
     * test if print method is invalid
     */
    public void testInvalidPrintBorrower()
    {
        ...
        {
            System.out.println("\ntestInvalidPrintBorrower");
            System.out.println("Output should be: Borrower with library number: 1003 not found.\n"
                                + "ACTUAL OUTPUT:");
